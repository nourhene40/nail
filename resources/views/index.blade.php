...
<!-- Mirrored from portotheme.com/html/wolmart/demo1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 08:58:56 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div class="header-top">
                <div class="container">
                    ...
                    <div class="header-right">
                        ...
                        @if(auth()->user()?->role == 'vendeur' || auth()->user()?->role == 'client')  <a href="contact-us" class="d-lg-show">Contact  Us</a> @endif
                        @if(auth()->user()?->role == 'client')  <a href="reclamation" class="d-lg-show">Complaint</a> @endif
                        <a href="aboutus" class="d-lg-show"> About  Us </a>
                     @if( auth()->user()?->role == 'client')   <a href="feedback">Feedback</a> @endif
                ...
                <div class="container">
                    <div class="header-left mr-md-4">
                        ...
                        <a href="demo1.html" class="logo ml-lg-0">
                            <img src="assets/images/cart/market.png" alt="Banner"
                            width="164" height="60" />
                        </a>
                    ...
                    <div class="header-right ml-4">
                        ...
                        @if(auth()->user()?->role == 'client'||auth()->user()?->role == 'vendeur')
...
@endif
        ...
        <main class="main">
            ...
            <!-- End of .category-section top-category -->
                ...
                <h2 class="title title-underline mb-4 ls-normal appear-animate"></h2>
