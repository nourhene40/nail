...
@section('abcd')
        ...
        <main class="main">
            ...
            <div class="page-header" style="background-color:#91ce96;">
                <div class="container">
            ...
            <div class="page-content become-a-vendor">
                <div class="container create-store pb-1 pb-lg-10 mb-10">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 order-md-first">
                            ...
                            <p>We made getting started with Walmart simple and easy, so you can offer your products to customers faster. Here's a summary of steps and requirements you should know before you join Zahou Marketplace
                            </p>
                            <a href="about-us.html" class="btn btn-dark btn-outline btn-rounded ls-25">Learn More</a>
                        </div>
                    </div>
                    <!-- End of Row -->
                </div>
                    ...
                    <div class="container mt-2 mt-lg-10 mb-0 mb-lg-10">
                        <div class="row align-items-center">
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <figure class="br-sm">
                                    <img width="1366" height="1351" src="https://marketplace.walmart.com/wp-content/uploads/2022/08/Asset-968.png" class="vc_single_image-img attachment-full" alt="" decoding="async" loading="lazy" title="Asset 968" srcset="https://marketplace.walmart.com/wp-content/uploads/2022/08/Asset-968.png 1366w, https://marketplace.walmart.com/wp-content/uploads/2022/08/Asset-968-300x297.png 300w, https://marketplace.walmart.com/wp-content/uploads/2022/08/Asset-968-1024x1013.png 1024w, https://marketplace.walmart.com/wp-content/uploads/2022/08/Asset-968-150x148.png 150w, https://marketplace.walmart.com/wp-content/uploads/2022/08/Asset-968-768x760.png 768w, https://marketplace.walmart.com/wp-content/uploads/2022/08/Asset-968-200x198.png 200w" sizes="(max-width: 1366px) 100vw, 1366px">
                ...
                <div class="container few-fees mt-10 mb-2 mb-lg-10 pt-2 pt-lg-9">
                    ...
                    <p class="text-center mb-2 mb-lg-10"></p>
                    <div class="row">
                ...
                <div class="bg-grey pt-2 pt-lg-10 wolmart-sellers pb-10">
                    <div class="container mt-0 mt-lg-10 mb-2 mb-lg-9"style="background-color:#91ce96;">
                        <div class="row">
                            <div class="col-lg-4 mb-4 mb-lg-0">
                                <h4 class="text-primary font-weight-bold ls-25">What they say</h4>
                                <h2 class="title text-left ls-25">Success stories from zahou sellers</h2>
                                <p>Offer your products on zahou.com where millions prefer to shop.

                                </p>
                                <a href="store" class="btn btn-dark btn-link btn-underline btn-icon-right">
                                        ...
                                        <div class="swiper-wrapper row cols-sm-2">
                                            <div class="swiper-slide testimonial-wrap">
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    ...
                                                    <blockquote>
                                                        Cheerful and positive attitude that benefits the entire team
                                                    </blockquote>
                                                    <cite class="ls-25">
                                            ...
                                            <div class="swiper-slide testimonial-wrap">
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    ...
                                                    <blockquote>
                                                        Fun and enthusiasm at work that inspires and motivates colleagues.
                                                    </blockquote>
                                                    <cite class="ls-25">
                                            ...
                                            <div class="swiper-slide testimonial-wrap">
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    ...
                                                    <blockquote>
                                                        Exemplary behavior that creates a climate of trust with the team.
                                                    </blockquote>
                                                    <cite class="ls-25">
                ...
                <div class="container questions mt-2 mt-lg-10 mb-5 mb-lg-9">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>You can continue adding more products now or you can come back and add more later even after your store is launched. If you have any questions about adding a product reach out  </p>
                            <h4 class="font-weight-bold ls-25">How can I know stock?</h4>
                            <p>To do this you can log into your zahou account and click on the icon cart</p>
                        </div>
                        <div class="col-md-6">
                            <h4 class="font-weight-bold ls-25">How do I get paid?</h4>
                            <p>Getting paid Funds are deposited into your zahou Pay account after you capture payment, and they will be automatically disbursed to your bank account on the next scheduled settlement date.</p>
                            <h4 class="font-weight-bold ls-25">Do I need a credit or debit card to create a shop?</h4>
                            <p> To make online purchases, you must have a payment method that’s accepted over the Internet. This typically means a credit card
